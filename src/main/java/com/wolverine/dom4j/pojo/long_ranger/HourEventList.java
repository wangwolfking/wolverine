 ...
 * File    Name: HourEventList.java
 * Create  Date: 2018-03-28 10:50
 ...
 * @author  yocaly team
 */
public class HourEventList {
    private List<HourEvent> hourEvents;

    public List<HourEvent> getHourEvents() {
        return hourEvents;
    }

    public void setHourEvents(List<HourEvent> hourEvents) {
