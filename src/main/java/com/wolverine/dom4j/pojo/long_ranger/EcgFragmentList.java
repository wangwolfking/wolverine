 ...
 * File    Name: EcgFragmentList.java
 ...
 * @author  yocaly team
 */
public class EcgFragmentList {
    private List<EcgFragment> ecgFragments;

    public List<EcgFragment> getEcgFragments() {
        return ecgFragments;
    }

    public void setEcgFragments(List<EcgFragment> ecgFragments) {
        this.ecgFragments = ecgFragments;
    }
