 ...
 * @author  yocaly team
 */
public class HRTList {
    private List<HRTItem> hrtItems;

    public List<HRTItem> getHrtItems() {
        return hrtItems;
    }

    public void setHrtItems(List<HRTItem> hrtItems) {
        this.hrtItems = hrtItems;
    }
